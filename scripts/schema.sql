-- ============================================================
-- MdLaw — Supabase 스키마 (Phase 1)
-- Supabase SQL Editor에서 순서대로 실행
-- ============================================================

-- 1. 한국어 trigram 검색을 위한 pg_trgm 확장 활성화
--    (Supabase에는 기본 탑재 — 활성화만 하면 됨)
...
-- ============================================================
-- 4. GIN 인덱스 — 한국어 trigram Full-Text Search
--    ILIKE '%키워드%' 쿼리에서 자동으로 사용됨
-- ============================================================
...
--    supabase.rpc('search_articles', { kw: '병상', lmt: 20 }) 형태로 호출
-- ============================================================
